...
public interface IGeneralData{
	...
	public enum Menuicons {Nothing, Login, SearchBook, SearchLibrarian, SearchSubscriber, SubscriberCard, ManagerCard, LibrarianCard, Exit, History, Report, catalog, CreateLoan, ReturnBook, CreateSubscriber, ChangeSubscriberStatus, Statistics, Connection};
	public enum MenuType {MainMenu, SubscriberMenu, LibrarianMenu, LibrarianManagerMenu};
